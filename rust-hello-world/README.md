...
Basic example of running [Rust](https://www.rust-lang.org) applications on [Zerops](https://zerops.io). Simple Actix Web API with single endpoint that reads from and writes to a PostgreSQL database.
