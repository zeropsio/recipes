# Bun Hello World — Remote Environment

This is a remote (CDE) environment for [Bun Hello World (info + deploy)](https://app.zerops.io/recipes/bun-hello-world?environment=remote-cde) recipe on [Zerops](https://zerops.io).
