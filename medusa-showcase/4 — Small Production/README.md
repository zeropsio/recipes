...
This is a small production environment for [Medusa (info + deploy)](https://app.zerops.io/recipes/medusa-showcase?environment=small-production) recipe on [Zerops](https://zerops.io).
