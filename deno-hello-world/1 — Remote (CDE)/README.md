# Deno Hello World — Remote Environment

This is a remote (CDE) environment for [Deno Hello World (info + deploy)](https://app.zerops.io/recipes/deno-hello-world?environment=remote-cde) recipe on [Zerops](https://zerops.io).
