# Java Hello World — AI Agent Environment

This is an AI agent environment for [Java Hello World (info + deploy)](https://app.zerops.io/recipes/java-hello-world?environment=ai-agent) recipe on [Zerops](https://zerops.io).
