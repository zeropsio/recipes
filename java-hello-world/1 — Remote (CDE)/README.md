# Java Hello World — Remote Environment

This is a remote (CDE) environment for [Java Hello World (info + deploy)](https://app.zerops.io/recipes/java-hello-world?environment=remote-cde) recipe on [Zerops](https://zerops.io).
