...
This is a local environment for [Next.js SSR Hello World (info + deploy)](https://app.zerops.io/recipes/nextjs-ssr-hello-world?environment=local) recipe on [Zerops](https://zerops.io).
