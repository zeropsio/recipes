...
This is a remote (CDE) environment for [Next.js SSR Hello World (info + deploy)](https://app.zerops.io/recipes/nextjs-ssr-hello-world?environment=remote-cde) recipe on [Zerops](https://zerops.io).
