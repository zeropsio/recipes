# Node.js Hello World — AI Agent Environment

This is an AI agent environment for [Node.js Hello World (info + deploy)](https://app.zerops.io/recipes/nodejs-hello-world?environment=ai-agent) recipe on [Zerops](https://zerops.io).
