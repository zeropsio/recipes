# Node.js Hello World — Remote Environment

This is a remote (CDE) environment for [Node.js Hello World (info + deploy)](https://app.zerops.io/recipes/nodejs-hello-world?environment=remote-cde) recipe on [Zerops](https://zerops.io).
