# Elixir Hello World — Remote Environment

This is a remote (CDE) environment for [Elixir Hello World (info + deploy)](https://app.zerops.io/recipes/elixir-hello-world?environment=remote-cde) recipe on [Zerops](https://zerops.io).
