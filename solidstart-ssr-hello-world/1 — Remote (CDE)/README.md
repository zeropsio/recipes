# SolidStart SSR Hello World - Remote Environment

This is a remote (CDE) environment for [SolidStart SSR Hello World (info + deploy)](https://app.zerops.io/recipes/solidstart-ssr-hello-world?environment=remote-cde) recipe on [Zerops](https://zerops.io).
