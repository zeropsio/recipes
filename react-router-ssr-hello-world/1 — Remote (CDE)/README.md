# React Router v7 SSR Hello World - Remote Environment

This is a remote (CDE) environment for [React Router v7 SSR Hello World (info + deploy)](https://app.zerops.io/recipes/react-router-ssr-hello-world?environment=remote-cde) recipe on [Zerops](https://zerops.io).
