# PHP Hello World — Remote Environment

This is a remote (CDE) environment for [PHP Hello World (info + deploy)](https://app.zerops.io/recipes/php-hello-world?environment=remote-cde) recipe on [Zerops](https://zerops.io).
