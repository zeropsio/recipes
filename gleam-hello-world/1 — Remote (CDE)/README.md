# Gleam Hello World — Remote Environment

This is a remote (CDE) environment for [Gleam Hello World (info + deploy)](https://app.zerops.io/recipes/gleam-hello-world?environment=remote-cde) recipe on [Zerops](https://zerops.io).
