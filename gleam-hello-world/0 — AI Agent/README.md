# Gleam Hello World — AI Agent Environment

This is an AI agent environment for [Gleam Hello World (info + deploy)](https://app.zerops.io/recipes/gleam-hello-world?environment=ai-agent) recipe on [Zerops](https://zerops.io).
