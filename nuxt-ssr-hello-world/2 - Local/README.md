# Nuxt SSR Hello World - Local Environment

This is [a local environment](https://app.zerops.io/recipes/nuxt-ssr-hello-world?environment=local) for [Nuxt SSR Hello World (info + deploy)](https://app.zerops.io/recipes/nuxt-ssr-hello-world?environment=local) recipe on [Zerops](https://zerops.io).
