...
This is a remote (CDE) environment for [Nuxt SSR Hello World (info + deploy)](https://app.zerops.io/recipes/nuxt-ssr-hello-world?environment=remote-cde) recipe on [Zerops](https://zerops.io).
