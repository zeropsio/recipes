...
This is a local environment for [Nuxt SSR Hello World (info + deploy)](https://app.zerops.io/recipes/nuxt-ssr-hello-world?environment=local) recipe on [Zerops](https://zerops.io).
