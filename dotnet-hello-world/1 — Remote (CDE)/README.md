# .NET Hello World — Remote Environment

This is a remote (CDE) environment for [.NET Hello World (info + deploy)](https://app.zerops.io/recipes/dotnet-hello-world?environment=remote-cde) recipe on [Zerops](https://zerops.io).
