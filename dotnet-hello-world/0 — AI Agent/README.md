# .NET Hello World — AI Agent Environment

This is an AI agent environment for [.NET Hello World (info + deploy)](https://app.zerops.io/recipes/dotnet-hello-world?environment=ai-agent) recipe on [Zerops](https://zerops.io).
