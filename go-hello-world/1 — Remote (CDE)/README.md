# Go Hello World — Remote Environment

This is a remote (CDE) environment for [Go Hello World (info + deploy)](https://app.zerops.io/recipes/go-hello-world?environment=remote-cde) recipe on [Zerops](https://zerops.io).
