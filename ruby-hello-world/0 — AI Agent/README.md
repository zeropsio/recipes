# Ruby Hello World — AI Agent Environment

This is an AI agent environment for [Ruby Hello World (info + deploy)](https://app.zerops.io/recipes/ruby-hello-world?environment=ai-agent) recipe on [Zerops](https://zerops.io).
