# Ruby Hello World — Remote Environment

This is a remote (CDE) environment for [Ruby Hello World (info + deploy)](https://app.zerops.io/recipes/ruby-hello-world?environment=remote-cde) recipe on [Zerops](https://zerops.io).
